...
def hello(hour, temperature, temperature_min, temperature_max, pressure, humidity, wind_speed, wind_deg, aqi, co, no2, o3, so2, pm2_5, pm10, nh3, hr):
    model = joblib.load('asthma_model.joblib')
    prediction = model.predict([[hour, temperature, temperature_min, temperature_max, pressure, humidity, wind_speed, wind_deg, aqi, co, no2, o3, so2, pm2_5, pm10, nh3, hr]])
